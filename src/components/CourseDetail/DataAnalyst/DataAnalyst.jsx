import './dataAnalyst.scss';
import { Data } from './Data.jsx';
import { Footer } from '../../Home/Footer';
import { WhyChoseMe } from '../UtilData/WhyChoseMe';
export const DataAnalystDetail = () => {
  return (
    <>
        ...
        <div className="content-box-5">
          ...
          <div className="module-3">
            <div className="left">
              ...
              <p className="day"> Day 4+5</p>
              <ul>
                <li>{Data.module3_row5}</li>
              </ul>
              <p className="day"> Day 6+7</p>
              <ul>
                <li>{Data.module3_row6}</li>
              </ul>
              <p className="day"> Day 8+9</p>
              <ul>
